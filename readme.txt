 ...
 ver. 3.0: changes by JD P (http://ww.moitah.net/)
			...
			* Added a feature to restore icons owned by RBTray
			...
			Also I included script for NSIS installer (http://nsis.sourceforge.net/) 
			in sources to allow contributors easily make setup file. If you make modified version
            please send me a note to nredko@gmail.com.	
